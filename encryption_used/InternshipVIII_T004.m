...
%% PARAMETERS
input_file = 'InternshipVIII_T004.txt';
encrypted_file = 'InternshipVIII_T004.bin';
decrypted_file = 'InternshipVIII_T004.dat';
...
%% RSA KEY GENERATION
fprintf('Generating RSA-4096 keys...\n');

tic;
keyGen = KeyPairGenerator.getInstance('RSA');
keyGen.initialize(4094);
